...
from .views import addproduct, edit_product_get, productlistview,supplierlistview, addsupplier,deletesupplier,deleteproduct,edit_product_get,edit_product_post,edit_supplier_get,edit_supplier_post, products_filtered, loginview, logout,login_action,logout_action,login,searchsuppliers
